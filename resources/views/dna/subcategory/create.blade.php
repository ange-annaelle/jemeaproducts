        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" action="{{ url('dna/subcategories') }}" enctype="multipart/form-data" method="post" >
                        @csrf
                    
                    <div class="col-md-4">
                        <label for="name" class="form-label">Select main category</label>
                        <select class="form-select {{ $errors->has('category_id') ? ' is-invalid' : '' }}" aria-label="Default select example" name="category_id">
                            <option value="{{null}}">Choose main category</option>
